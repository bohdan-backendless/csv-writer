...
describe('Write object records into CSV', function () {
    ...
    describe('When only path and header ids are given', function () {
        ...
        it('writes records to a new file', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe('When header ids are given with reverse order', function () {
        ...
        it('also writes columns with reverse order', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, writer.writeRecords(records)];
                    case 1:
    ...
    describe('When field header is given with titles', function () {
        ...
        it('writes a header', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, writer.writeRecords(records)];
                    case 1:
    ...
    describe('When `append` flag is specified', function () {
        ...
        it('do not overwrite the existing contents and appends records to them', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe('When encoding is specified', function () {
        ...
        it('writes to a file with the specified encoding', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, writer.writeRecords(records)];
                    case 1:
    ...
    describe('When semicolon is specified as a field delimiter', function () {
        ...
        it('uses semicolon instead of comma to separate fields', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, writer.writeRecords(records)];
                    case 1:
    ...
    describe('When newline is specified', function () {
        ...
        it('writes to a file with the specified newline character', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, writer.writeRecords(records)];
                    case 1:
